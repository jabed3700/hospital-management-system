      ...
      <!-- Notifications Dropdown Menu -->
       ...
       <li class="dropdown user user-menu" style="margin-top: 9px;">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          <img style="margin-top:4px" src="../admin/avater/<?=$_SESSION["pharmacist"]["image"]?>" class="user-image" alt="User Image">
          <span class="hidden-xs"><?=$_SESSION["pharmacist"]["username"]?></span>
        </a>
        
        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-right" id="drop">
          <!-- User image -->
          <li class="user-header">
            <img src="../admin/avater/<?=$_SESSION["pharmacist"]["image"]?>" class="img-circle" alt="User Image">
