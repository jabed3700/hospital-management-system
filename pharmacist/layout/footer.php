...
<footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="#">Hub Medical Center</a>.</strong>
    All rights reserved.
...
<script>
  ...
  xhttp.open("GET", "../getmessage.php?sender="+<?=$doctor_id?>+"&reciever="+id, true);
  xhttp.send();
  ...
  xhttp.open("GET", "../sendmessage.php?sender="+<?=$doctor_id?>+"&reciever="+reciever+"&message="+message, true);
  xhttp.send();
