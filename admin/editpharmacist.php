...
<?php
 ...
 $upda = mysqli_query($con,"UPDATE pharmacist SET name='$name',username='$username',contact='$contact' WHERE id=$hiddenid");

 header('location: pharmacistlist.php');
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="editpharmacist.php" enctype="multipart/form-data">
                <div class="card-body">
