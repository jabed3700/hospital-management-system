    ...
    <div class="card-body login-card-body">
      ...
      if(isset($_GET['type'])){
        if($_GET['type']=='doctors'){
          echo "<a href='recovery.php?t=doctors'>I forgot my password</a>";
        }elseif($_GET['type']=='admin'){
          echo "<a href='recovery.php?t=admin'>I forgot my password</a>";
        }elseif($_GET['type']=='nurse'){
          echo "<a href='recovery.php?t=nurse'>I forgot my password</a>";
        }elseif($_GET['type']=='pharmacist'){
          echo "<a href='recovery.php?t=pharmacist'>I forgot my password</a>";
        }
